                  ...
                  <div class="container">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-12">
                        ...
                        <h2 class="page-header">Form Pengisian Tanggal Wawancara</h2>
                        ...
                        <form method="POST" action="simpan.php?page=tglwawancara.php" enctype="multipart/form-data">
                            ...
                            <textarea hidden class="form-control" cols="40" rows="5" name="tambahan_file" value="<?php echo $tambahan_file; ?>" required><?php echo $tambahan_file; ?></textarea>
                                ...
                                <textarea hidden class="form-control" cols="40" rows="5" name="hpd" required><?php echo $hpd; ?></textarea>
