...
$sdd = "Select * from user where tahap1 = 1";
						...
						<table class="table table-striped table-bordered table-hover dataTables-example">
							...
							<thead>
								...
								<tr>
									...
									<th>Tgl Wawancara (1)</th>

									<th>Tgl Wawancara (2)</th>
									...
									<th><div style="width: 200px;">KRS</div></th>

									<th><div style="width: 200px;">Link Drive</div></th>

									<th>Kelulusan Tahap Wawancara</th>

									<th>Kembalikan Ke Tahap 1</th>
							...
							<tbody>
								...
								?>
									...
									<tr>
										...
										<td><strong><?= $row['motivasi']; ?></strong></td>

										<td><strong><?= $row['motivasi1']; ?></strong></td>
										...
										<td><a href="../../oprec_volunteer21/masuk/krs/<?=$row['tambahan_file'];?>" download><u><?=$row['tambahan_file'];?></u></a></td>

										<td><a href="<?= $row['hpd']; ?>" target="_blank"><u><?= $row['hpd']; ?></u></a></td>

										<td>

											<a href="JavaScript:newPopup('lulus2.php?nama=<?= $row['nama']; ?>&npm=<?= $row['npm']; ?>&username=<?= $row['username']; ?>');">LULUSKAN WAWANCARA</a>

										</td>

										<td>

											<a href="../delete.php?id=<?= $row['id']; ?>&page=min2" onclick="return confirm('Apakah kamu yakin ingin mengembalikan <?= $row['nama']?> ke tahap sebelumnya?')">KEMBALIKAN</a>
