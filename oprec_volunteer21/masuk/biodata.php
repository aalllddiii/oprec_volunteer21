                  ...
                  <div class="container">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-12">
                        ...
                        <!-- <h2 class="page-header">Form Biodata</h2><br> -->
                        ...
                        <form method="POST" action="simpan.php?page=biodata.php" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" pattern="[a-zA-Z0-9\s]+" value="<?php echo $nama; ?>" name="nama" required>

                            <br>

                            <label>NPM</label><br>

                            <input type="text" class="form-control" minlength="8" maxlength="8" pattern="[^' ']+([0-9])"
                              value="<?php echo $npm; ?>" name="npm" required>
                            ...
                            <textarea type="text" class="form-control" cols="40" rows="5" name="alamat"
                            ...
                            <input type="text" class="form-control" value="<?php echo $id_line; ?>" name="id_line"
                              required>
                            ...
                            <input type="text" class="form-control" pattern="([0-9]).{}" value="<?php echo $no_hp; ?>"
                              name="no_hp" required>

                            <br>

                            <label>Deskripsikan tentang diri kamu</label><br>

                            <textarea type="text" class="form-control" cols="40" rows="5" name="gambarDiri"
                              required><?php echo $gambarDiri; ?></textarea>

                            <br>

                            <label>Moto hidup</label><br>

                            <textarea type="text" class="form-control" cols="40" rows="5" name="motoHidup"
                              required><?php echo $motoHidup; ?></textarea>

                            <br>

                            <label>Apa alasan kamu ingin menjadi volunteer pada proker yang kamu pilih?</label><br>

                            <textarea type="text" class="form-control" cols="40" rows="5" name="alasan"
                              required><?php echo $alasan; ?></textarea>
                            ...
                            <label>Kamu Terdaftar di Acara <strong> <?= $acara ?> </strong>, Pilih Divisi yang kamu
                              inginkan di bawah :</label>
                            ...
                            <select class="form-control" name="divisi1_2">
                              ...
                              <label>Kamu Terdaftar di Acara <strong> <?= $acara2 ?> </strong>, Pilih Divisi yang kamu
                                inginkan di bawah :</label>
                              ...
                              <label style="color:red;"><b>Format nama file : Foto_Nama</b></label><br>

                              <label><b>*Foto Formal(Kemeja bebas dan sopan) ukuran 4 x 6 background merah</b></label>

                              <input type="file" class="form-control" name="upload">
                              <span><b>Foto : </b><?php $a = explode('.',$upload,3); echo $a[2] ?></span><br>

                              <br><br><label>Upload KRS</label><br>

                              <label style="color:red;"><b>Format nama file : KRS_Nama</b></label><br>

                              <b><label>Jenis file PDF dan maksimum size 5MB</label></b><br>

                              <input type="file" class="form-control" name="tambahan_file">
                              <span><b>KRS : </b><?php $a = explode('_',$tambahan_file,3); echo $a[2] ?></span><br>

                              <br><br>

                              <label>Jika kamu memilih Divisi <b>Media</b>, wajib mencantumkan link gdrive portofolio
                                yang telah diberikan akses. <br> Portofolio bisa berupa <b>poster</b> atau
                                <b>video</b></label><br>

                              <label style="color:red;"><b>Apabila tidak memilih divisi Media, harap
                                  dikosongkan</b></label><br>

                              <textarea type="text" class="form-control" cols="40" rows="5"
                                name="hpd"><?php echo $hpd; ?></textarea>
                              ...
                              <?php if($form_biodata == 0){
                              echo "<button class='btn btn-danger' value='simpan'>Simpan</button>";
                              }else{
                              echo "<h5 style='color: red; text-align:center;'>Maaf, Form pengisian biodata telah ditutup!</h5>";
                              }?>
            ...
            <div class="col-lg">
              ...
              <div class="p-5">
                ...
                <form class="form-setting" method="POST" action="ubah.php">
                  ...
                  <b>Pilihan Divisi</b> akan terhapus setelah kamu mengubah pilihan acara. <br>
                  </label>
